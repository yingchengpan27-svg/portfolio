...
|------|--------|------|
| `id` | `3` | **不要改** |
| `title` | `ZURU潮玩创意广告` | 小卡标题 |
| `category` | `AI视觉创作` | 左上角徽章 |
| `desc` | `独立负责创意广告全链路流程，通过AI创作形式放大产品卖点。覆盖文生图 / 文生视频 / 角色一致性等 AI 工作流，让产品创意更快、更准地触达目标用户。` | 50-80 字 |
| `tags` | `['品牌广告', '多模态', '创意脚本']` | 当前未渲染 |
